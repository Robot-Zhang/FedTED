...
class Server(Base_Server):
    def __init__(self, generator, gen_epochs, gen_lr=1e-4, rebuild_epochs=10, heterogeneous: bool = False, mode='all',
                 **kwargs):
        """
        Args:
        ...
        assert mode in ['all', 'td', ], "mode is for ablation experiment"
        self.mode = mode
